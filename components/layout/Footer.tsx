...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#363333] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-oswald text-lg font-semibold text-[#dabb64] mb-4 tracking-wide">
              QUICK LINKS
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+13125551234" className="hover:text-white transition-colors">
                  (312) 555-1234
                </a>
              </li>
              <li className="flex items-center gap-2">
